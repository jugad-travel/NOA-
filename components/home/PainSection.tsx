...
const comparison = {
  before: {
    ...
    items: [
      { text: "Navigation rigide" },
      { text: "Décision complexe" },
      { text: "Réassurance insuffisante" },
      { text: "Trop de choix" },
      { text: "Abandon fréquent" },
      { text: "Faible fidélisation" },
    ],
  },
  after: {
    title: "Avec PARCEL",
    items: [
      { text: "Compréhension fine de l'intention client" },
      { text: "Arbitrage produit piloté par les règles métier" },
      { text: "Décision expliquée jusqu'à l'achat" },
      { text: "Conversion optimisée par la décision" },
      { text: "Parcours guidé et contextualisé" },
      { text: "Réduction du temps de décision" },
    ],
  },
}
