      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <ScrollReveal delay={0.2}>
            <div className="relative group">
              <div className="bg-white border-2 border-brand-blue/30 rounded-3xl p-8 hover:shadow-lg hover:shadow-brand-blue/10 transition-all">
                <div className="flex items-center gap-3 mb-6">
                ...
                <ul className="space-y-4">
                  {comparison.after.items.map((item, index) => (
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-brand-cyan/20 to-brand-blue/20 flex items-center justify-center flex-shrink-0">
