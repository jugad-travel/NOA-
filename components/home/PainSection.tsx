        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <ScrollReveal delay={0.1}>
            <div className="relative group">
              ...
              <div className="relative bg-dark-50/50 border border-red-500/20 rounded-3xl p-8">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-red-500/10 flex items-center justify-center">
                    <X className="w-5 h-5 text-red-400" />
                  </div>
                  <h3 className="text-xl font-semibold text-white">{comparison.before.title}</h3>
                </div>
          ...
          <ScrollReveal delay={0.2}>
            <div className="relative group">
              ...
              <div className="relative bg-dark-50/50 border border-brand/20 rounded-3xl p-8">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-brand/10 flex items-center justify-center">
                    <Check className="w-5 h-5 text-brand" />
                  </div>
                  <h3 className="text-xl font-semibold text-white">{comparison.after.title}</h3>
                </div>
                <ul className="space-y-4">
